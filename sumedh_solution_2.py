...
fig = plt.figure()
plt.subplot(121)
plt.scatter(x_,y_,c='green', label='Video 1 data points')
plt.plot(x_ ,leastSquare_1, c='red', label='Video 1 Least Squares')
plt.legend()
plt.subplot(122)
plt.scatter(x_0,y_0,c='blue', label='Video 2 data points')
plt.plot(x_0 ,leastSquare_2, c='red', label='Video 2 Least Squares')
plt.legend()
plt.show()
